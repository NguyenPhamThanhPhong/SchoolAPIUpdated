        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    studentMax = table.Column<int>(type: "int", nullable: false),
                    semesterid = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "SchoolClassRegistrationSchoolClasses",
                columns: table => new
                {
                    SchoolClassRegistrationid = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    schoolClassesid = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolClassRegistrationSchoolClasses", x => new { x.SchoolClassRegistrationid, x.schoolClassesid });
                    table.ForeignKey(
                        name: "FK_SchoolClassRegistrationSchoolClasses_schoolClassRegistrations_SchoolClassRegistrationid",
                        column: x => x.SchoolClassRegistrationid,
                        principalTable: "schoolClassRegistrations",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SchoolClassRegistrationSchoolClasses_schoolClasses_schoolClassesid",
            ...
            migrationBuilder.CreateTable(
                name: "ScheduleTableSchedules",
                columns: table => new
                {
                    ScheduleTableid = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    schedulesschoolClassId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleTableSchedules", x => new { x.ScheduleTableid, x.schedulesschoolClassId });
                    table.ForeignKey(
                        name: "FK_ScheduleTableSchedules_scheduleTables_ScheduleTableid",
                        column: x => x.ScheduleTableid,
                        principalTable: "scheduleTables",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleTableSchedules_schedules_schedulesschoolClassId",
                        column: x => x.schedulesschoolClassId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleTableSchedules_schedulesschoolClassId",
                table: "ScheduleTableSchedules",
                column: "schedulesschoolClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolClassRegistrationSchoolClasses_schoolClassesid",
                table: "SchoolClassRegistrationSchoolClasses",
